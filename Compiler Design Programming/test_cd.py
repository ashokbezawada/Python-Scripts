...
def backto_original(final_tokens2,file_path1):
    ...
    return
# The main goal of the function is to print the keywords in the tokens
# The function takes input as final_tokens and returns all keywords

def print_keywords(final_tokens1):
    for i in final_tokens1:
        if (i == "for" or i == "if" or i == "else" or i == "while"):
            print("The keyword found in tokens is :" ,i)

    return

# main function
input_file = open("F:\\python_scripts\\Compiler Design Programming\\project_sample.txt",'r')
final_tokens=[]  
le_str1 = ""
